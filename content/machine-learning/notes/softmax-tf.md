...
with tf.Session() as sess:
    ...
    for epoch in range(training_epochs):
        ...
        _, c = sess.run([optimizer, cost], feed_dict={x: training_input, y: training_output})
        avg_cost += c
    ...
    print("Accuracy:", accuracy.eval({x: testing_input, y: testing_output}))
```